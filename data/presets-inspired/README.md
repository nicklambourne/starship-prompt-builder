...
colours, separators and spacing were derived from Powerlevel10k's official
`config/p10k-lean.zsh`, `config/p10k-classic.zsh` and
`config/p10k-rainbow.zsh` at commit
`3308262dfbd743b6e1d3956a2b5572f7a049d692`, retrieved 2026-09-01.
